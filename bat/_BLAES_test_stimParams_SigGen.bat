...
Start executable SignalGenerator --local --LogKeyboard=1 --LogWebcam=1
...
Load parameterfile "C:/Paradigms/parms/BLAES/_BLAES_param_sweep/BLAES_stimsweep_test.prm"
Load parameterfile "C:/Paradigms/parms/BLAES/_BLAES_param_sweep/BLAES_stimsweep_appWindow.prm"

set parameter SubjectName testing
set parameter SubjectSession 001
set parameter DataDirectory ..\data\Will
